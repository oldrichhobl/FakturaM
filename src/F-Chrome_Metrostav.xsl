...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/REC-html40">
  <INFO>
    <SUBJECT>Faktura Metrostav</SUBJECT>
  ...
  <ORIGIN>
    ...
    <SESTAVAN>1</SESTAVAN>
    <POPIS>
      Faktura Chrome pro firmu Metrostav dle vzoru z 17.12.2007
    </POPIS>
    <HIST>
...
.mjd,.mnd,.jcd,.ucd,.dphd {text-align: right;}
    ...
    <table id="telohead">
      <THEAD>
        <TR>
          ...
          <TD>Množství</TD>
          <TD>jedn.cena</TD>
          <TD>Úhrnná částka <br/>základu daně</TD>
        </TR>
      </THEAD>
      <TBODY>
  ...
  <xsl:template name="vykony">
    <TR class="vykon">
      <TD class="poznd noborder">
        Stazka:<xsl:value-of select="../CISLOSTAZKY"/>
      </TD>
      <TD class="dphd leftborder">
